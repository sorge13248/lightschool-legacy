...
<style type="text/css">
  ...
  *{
  ...
  html{
    background-image: url("http://images.alphacoders.com/741/74183.jpg");
  ...
  @media screen and (min-width:630px) {
    ...
    .content{
      ...
      background-color: white;
      -webkit-box-shadow: 0px 0px 30px 0px rgba(50, 50, 50, 1) !important;
      -moz-box-shadow:    0px 0px 30px 0px rgba(50, 50, 50, 1) !important;
      box-shadow:         0px 0px 30px 0px rgba(50, 50, 50, 1) !important;
    }
    .text_min, .text_min2{
      display: none !important;
    }
  ...
  .send_message input[type=submit]{
    ...
    cursor: pointer;
    background-color: transparent;
    background-image: url("<?= $IMAGES_MAIN_DIRECTORY ?>/black/sent.png");
    background-repeat: no-repeat;
