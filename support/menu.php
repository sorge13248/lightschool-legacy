<?php
  ...
  }elseif($current_page == 'docs'){
    $DOCS_SELECTED = 'active';
  }elseif($current_page == 'ticket' or $current_page == 'tickets'){
    $TICKET_SELECTED = 'active';
  }elseif($current_page == 'submit'){
    $SUBMIT_SELECTED = 'active';
  }
?>
<nav class="navbar navbar-default navbar-inverse navbar-fixed-top">
  <div class="container">
	...
	<span class="icon-bar"></span>
      ...
      <a class="navbar-brand hide_control" href="<?= $SUPPORT_MAIN_DIRECTORY ?>/home" style="display: none"><img src="<?= $IMAGES_MAIN_DIRECTORY ?>/logo2.png" style="width: 22px; height: 22px; float: left; margin-right: 10px" />Supporto di LightSchool</a>
    </div>
    <div id="navbar" class="navbar-collapse collapse">
      <ul class="nav navbar-nav">
	<li class="<?= $HOME_SELECTED ?> show_control" style="display: block"><a class="navbar-brand" href="<?= $SUPPORT_MAIN_DIRECTORY ?>/home"><img src="<?= $IMAGES_MAIN_DIRECTORY ?>/logo2.png" style="width: 22px; height: 22px; float: left; margin-right: 10px" />Supporto</a></li>
	<li class="<?= $HOME_SELECTED ?> hide_control" style="display: none"><a href="<?= $SUPPORT_MAIN_DIRECTORY ?>/home">Home</a></li>
	<!-- <li><a href="#about">Studenti e docenti</a></li>
	<li><a href="#contact">Scuole</a></li>
	<li><a href="#contact">Editori</a></li> -->
	<li class="<?= $DOCS_SELECTED ?>"><a href="<?= $SUPPORT_MAIN_DIRECTORY ?>/docs">Categorie</a></li>
	<?php if($_SESSION['Username'] != ''){ ?>
	  ...
	  <li class="hide_control" style="display: none"><a href="<?= $SUPPORT_MAIN_DIRECTORY ?>/tickets">I miei ticket</a></li>
	  <li class="hide_control" style="display: none"><a href="<?= $SUPPORT_MAIN_DIRECTORY ?>/submit">Apri un nuovo ticket</a></li>
	  <li class="hide_control" style="display: none"><a href="<?= $MY_MAIN_DIRECTORY ?>/logout">Esci</a></li>
	  <li class="dropdown show_control <?= $ACCOUNT_SELECTED.$TICKET_SELECTED.$SUBMIT_SELECTED ?>" style="display: block"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="<?= $USER_image ?>" style="border-radius: 50%; height: 18px; width: 18px; margin-right: 10px" />Ciao <?php echo($USER_name) ?> <b class="caret"></b></a>
		...
		<a href="<?= $MY_MAIN_DIRECTORY ?>/">Il mio account</a>
	      ...
	      <li class="<?= $TICKET_SELECTED ?>"><a href="<?= $SUPPORT_MAIN_DIRECTORY ?>/tickets">I miei ticket</a></li>
	      <li class="<?= $SUBMIT_SELECTED ?>"><a href="<?= $SUPPORT_MAIN_DIRECTORY ?>/submit">Apri un ticket</a></li>
