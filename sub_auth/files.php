...
if($numUSER == 1){
  ...
  $ESCAPE_f = $conn->real_escape_string($_GET['f']);
  $sql = "SELECT * FROM MY_files WHERE Username = '$USER_APP_USERNAME' AND folder = '$ESCAPE_f' AND (type = 'notebook' OR type = 'folder' OR type = 'file' OR type = 'stuff') AND history = '' AND trash = '' ORDER BY $FILES_ORDER_TEXT";
