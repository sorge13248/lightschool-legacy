<?php
  ...
  $MY_MAIN_DIRECTORY = '//MAIN_HTTP_ADDRESS/sub_editori';
  $MAIN_DIRECTORY = '//MAIN_HTTP_ADDRESS/preview_sub';
  $IMAGES_MAIN_DIRECTORY = '//MAIN_HTTP_ADDRESS/images_sub';
  $UPLOAD_MAIN_DIRECTORY = '//MAIN_HTTP_ADDRESS/sub_editori';
  $SUPPORT_MAIN_DIRECTORY = '//MAIN_HTTP_ADDRESS/sub_editori/support';
  ...
  if($_GET['only_reference'] != 'true'){
	...
	<html>
      ...
      $sql="SELECT * FROM PB_users WHERE Username = '$USERNAMESESSIONESCAPE' LIMIT 1";
	...
	while($row = $rs->fetch_assoc()){
	  ...
	  $USER_ref_company = $row['ref_company'];
	  ...
	  $USER_ref_company = $conn->real_escape_string($USER_ref_company);
      ...
      $USER_ref_company = $conn2->real_escape_string($USER_ref_company);
      $sql2="SELECT * FROM PB_users WHERE UserID = '$USER_ref_company' LIMIT 1";
	...
	}, 1000); <?php // 300000 every 5 minutes ?>
