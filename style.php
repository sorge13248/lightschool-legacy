...
<script src="<?= $MAIN_DIRECTORY ?>/Library/jquery.min.js"></script>
<link rel="stylesheet" href="<?= $MAIN_DIRECTORY ?>/Library/bootstrap.min.css" integrity="sha384-1q8mTJOASx8j1Au+a5WDVnPi2lkFfwwEAa8hDDdjZlpLegxhjVME1fgjWPGmkzs7" crossorigin="anonymous">
<script src="<?= $MAIN_DIRECTORY ?>/Library/bootstrap.min.js" integrity="sha384-0mSbJDEHialfmuBBQP6A4Qrprq5OVfW37PRR3j5ELqxss1yVqOtnepnHVP9aJ7xS" crossorigin="anonymous"></script>
<?php if($current_page == 'home'){ ?>
  <!-- Important Owl stylesheet -->
  <link rel="stylesheet" href="<?= $MAIN_DIRECTORY ?>/owl-carousel/owl.carousel.css">
  <!-- Default Theme -->
  <link rel="stylesheet" href="<?= $MAIN_DIRECTORY ?>/owl-carousel/owl.theme.css">
<?php } ?>
...
<style type="text/css">
  ...
  *{
  ...
  <?php if($current_page == 'home'){ ?>
    ...
    .navbar-default, .dropdown-menu, .dropdown-menu > li > a:hover {
...
.bkg_classroom{
  ...
  margin-top: -20px;
  background-image: url('macbook-air-4.png');
  background-repeat: no-repeat;
  background-attachment: fixed;
