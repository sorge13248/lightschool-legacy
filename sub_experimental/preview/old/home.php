...
<html>
  ...
  <body>
    ...
    <div class="slide" id="slide1">
      <div data-sr="scale up 20% wait 1s" align="center">
	<table cellpadding="20" style="width: 100%">
	  <tr>
	    <td style="padding-left: 6%; width: 510px">
	      <img src="<?= $IMAGES_MAIN_DIRECTORY ?>/pc-render.png" style="width: 500px" />
	    </td>
	    <td style="padding-right: 6%">
	      <p style="font-size: 30pt; color: white; text-align: center"><?php echo($TRAD_welcome_text); ?></p>
	      <?php echo($TRAD_welcome_subtitle); ?>
	    </td>
	  </tr>
	</table>
      </div>
